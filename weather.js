...
function changeBg(status) {
    if (status === 'Clouds') {
        document.body.style.backgroundImage = 'url(/Users/ujjwalsmac/Downloads/clouds.jpg)';
    } else if (status === 'Rain') {
        document.body.style.backgroundImage = 'url(/Users/ujjwalsmac/Downloads/rainy.jpg)';
    } else if (status === 'Clear') {
        document.body.style.backgroundImage = 'url(/Users/ujjwalsmac/Downloads/clear.jpg)';
    }
    else if (status === 'Snow') {
        document.body.style.backgroundImage = 'url(/Users/ujjwalsmac/Downloads/snow.jpg)';
    }
    else if (status === 'Sunny') {
        document.body.style.backgroundImage = 'url(/Users/ujjwalsmac/Downloads/sunny.jpg)';
    } else if (status === 'Thunderstorm') {
        document.body.style.backgroundImage = 'url(/Users/ujjwalsmac/Downloads/thunderstrom.jpg)';
    } else if (status === 'Drizzle') {
        document.body.style.backgroundImage = 'url(/Users/ujjwalsmac/Downloads/drizzle.jpg)';
    } else if (status === 'Mist' || status === 'Haze' || status === 'Fog') {
        document.body.style.backgroundImage = 'url(/Users/ujjwalsmac/Downloads/mist.jpg)';
    }

    else {
        document.body.style.backgroundImage = 'url(/Users/ujjwalsmac/Downloads/bg.jpg)';
    }
}
